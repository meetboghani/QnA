...
$str="SELECT * from question, user where  user.user_id=question.user_id AND question_id=$_GET[qid]";
	...
	{	
		while($row = mysqli_fetch_array($result))
		{
			...
			echo $head;	
			echo "</h4>";
			echo "<span class='box5'>";
			echo "<span class='head2'><a href='answer.php?id=$_GET[qid]'>REPLY</a></span>";
...
<?php
	...
	{	
		...
		while($row1 = mysqli_fetch_array($result))
		{
			...
			echo "<span class='box5'>";
			echo "<span class='head2'><a href='answer.php?id=$_GET[qid]'>REPLY</a><a href='like.php?id=$row1[answer_id] ' class='view2' >Like $row1[like]</a> <a href='dwdpap.php?id=$_GET[qid]' class='view2'>Download</a>
</span>";
